...
public class BookingController {
    ...
    @GetMapping("/owner")
    public List<BookingDto> getAllBookingsByOwnerItems(@RequestHeader("X-Sharer-User-Id") @Positive Long userId,
                                                       @RequestParam(defaultValue = "ALL") String state,
                                                       @RequestParam(defaultValue = "0") @PositiveOrZero Integer from,
                                                       @RequestParam(defaultValue = "10") @Positive Integer size) {
        BookingState bookingState = BookingState.fromString(state)
    ...
    public ResponseEntity<BookingDto> approveOrRejectBooking(@RequestHeader("X-Sharer-User-Id") @Positive Long userId,
