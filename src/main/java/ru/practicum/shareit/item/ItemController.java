...
public class ItemController {
    ...
    public ItemDto getById(@RequestHeader(USER_ID_HEADER) Long userId, @PathVariable Long itemId) {
        // Note: userId header is passed but not strictly validated here for retrieval.
        // Validation happens inside the service if needed based on context (e.g., for owner details).
