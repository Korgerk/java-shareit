...
CREATE TABLE IF NOT EXISTS items (
  ...
  CONSTRAINT fk_item_request_id FOREIGN KEY (request_id) REFERENCES item_requests(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS item_requests (
  ...
  CONSTRAINT fk_item_request_requestor_id FOREIGN KEY (requestor_id) REFERENCES users(id) ON DELETE CASCADE
);